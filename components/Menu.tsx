...
const Menu = () => {
  ...
  return (
    <div className="flex flex-col items-center bg-black min-h-screen p-6 w-full">
      <h1 className="text-white text-2xl font-bold mb-4 md:text-4xl lg:text-6xl">Menus</h1>
        ...
        {menuData.map((item, index) => (
          ...
          >
            ...
            <div className="absolute inset-0 flex items-center justify-center">
              <h2 className="text-white text-lg md:text-3xl lg:text-5xl font-semibold">{item.name}</h2>
            </div>
          </div>
        ))}
      </div>
