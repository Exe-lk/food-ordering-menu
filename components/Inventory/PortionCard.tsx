...
const PortionCard = ({ portions, onEdit, onRemove }: PortionCardProps) => {
  return (
    <div className="mt-5 space-y-6"> {/* Increased gap between cards */}
      {portions.map((portion, index) => (
        <div 
          key={index} 
          className="flex items-center justify-between border rounded-lg shadow-md p-4 bg-white hover:bg-gray-300 transition-all duration-300"
        >
          ...
          <div className="flex space-x-2 justify-center w-40"> {/* Fixed width for uniformity */}
            <button
