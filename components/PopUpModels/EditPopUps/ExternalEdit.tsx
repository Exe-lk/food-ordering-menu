...
const ExternalEdit = ({isOpen, onClose,product}:EditProps) => {
    ...
    const { suppliers, loading: suppliersLoading } = useSelector((state: RootState) => state.supplier);
    ...
    const handleAddSupplier = () =>{
      ...
      const handleSupplierChange = (index:number, key:string, value:string) =>{
        const updatedSupplier = supplier.map((supp, i) => (i === index ? { ...supp, [key]: value } : supp));
        setSupplier(updatedSupplier);
      };
    ...
    <div className="fixed inset-0 bg-black bg-opacity-75 flex justify-center items-center z-50 text-black">
        <div className="bg-white rounded-lg shadow-lg p-10 w-[650px] max-h-[700px] overflow-y-auto">
            ...
            <form onSubmit={handleSubmit}>
                <div className="mt-3">
                    <label htmlFor="iamge" className="block text-gray-700 font-medium">Image</label>
                    <div
                        {...getRootProps()}
                    ...
                    >
                        ...
                        {isDragActive ? (
                            ...
                            <div className="flex flex-col items-center">
                                <img src={updatedProduct.currentImageUrl} alt="Preview"
                                    className="w-40 h-40 object-cover rounded-lg mb-2"
                                />
                                <p>Drag & Drop to replace or click to upload a new image</p>
                            </div>
                        ):(
                            <>
                                ...
                                <p className="mt-2 text-gray-700">
                                    {updatedProduct.currentImageUrl
                                    ? "Current imgae loaded. Drag & Drop to replace or Click to upload a new image"
                ...
                <div className="mt-3">
                    <label htmlFor="menu" className="block text-gray-700 font-medium">Category</label>
                    <select 
                        name="" 
                        id=""
                        className="w-full border rounded-lg p-2 focus:outline-none focus:ring-2 focus:ring-blue-300"
                        ...
                        <div className="flex flex-col">
                            ...
                            <div className="relative">
                                <input
                                    ...
                                    onChange={(e) => setUpdatedProduct({ ...updatedProduct, manufactureDate: e.target.value })}
                                />
                            </div>
                        </div>
                        <div className="flex flex-col">
                        ...
                        <div className="flex flex-col">
                            ...
                            <div className="relative">
                                <input
                                    ...
                                    onChange={(e) => setUpdatedProduct({ ...updatedProduct, dateIn: e.target.value })}
                                />
                            </div>
                        </div>
                    </div>
