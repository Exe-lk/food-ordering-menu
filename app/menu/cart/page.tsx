...
import { removeFromCart, RootState, updateQuantity } from '@/redux/store';
...
const CartPage = () => {
    ...
    const handleQuantityChange = (name: string, portion: string, newQuantity: number) => {
      if (newQuantity > 0) {
    ...
    return (
      <div className="bg-black min-h-screen text-white p-4 flex flex-col">
        ...
        <div className="flex-grow w-full mx-auto overflow-y-auto" style={{ maxHeight: '70vh' }}>
              ...
              <div className="flex-grow px-4">
                ...
                <div className="flex items-center mt-2">
                  <button
                    ...
                    onClick={() => handleQuantityChange(item.name, item.portion, item.quantity - 1)}
                  >
                    -
                  </button>
